...
Route::prefix('/')->group(function () {
    ...
    Route::group(['middleware' => 'admin.auth.admin:admin'], function(){
        ...
        //room
        Route::prefix('/manager-room')->as('room.')->group(function(){
            Route::controller(App\Admin\Http\Controllers\Room\RoomController::class)->group(function(){
                Route::get('/add', 'create')->name('create');
                Route::get('/', 'index')->name('index');
                Route::get('/edit/{id}', 'edit')->name('edit');
                Route::put('/edit', 'update')->name('update');
        ...
        //roomtype
        Route::prefix('/manager-roomtype')->as('roomtype.')->group(function(){
            Route::controller(App\Admin\Http\Controllers\Roomtype\RoomtypeController::class)->group(function(){
                Route::get('/add', 'create')->name('create');
                Route::get('/', 'index')->name('index');
                Route::get('/edit/{id}', 'edit')->name('edit');
                Route::put('/edit', 'update')->name('update');
        ...
        //booking
        Route::prefix('/manager-booking')->as('booking.')->group(function(){
        ...
        //amenities
        Route::prefix('/manager-amenities')->as('amenities.')->group(function(){
            Route::controller(App\Admin\Http\Controllers\Amenities\AmenitiesController::class)->group(function(){
                Route::get('/add', 'create')->name('create');
                Route::get('/', 'index')->name('index');
                Route::get('/edit/{id}', 'edit')->name('edit');
                Route::put('/edit', 'update')->name('update');
        ...
        //service
        Route::prefix('/manager-service')->as('service.')->group(function(){
            Route::controller(App\Admin\Http\Controllers\Service\ServiceController::class)->group(function(){
                Route::get('/add', 'create')->name('create');
                Route::get('/', 'index')->name('index');
                Route::get('/edit/{id}', 'edit')->name('edit');
                Route::put('/edit', 'update')->name('update');
