...
//    ],
    ...
    [
        ...
        'sub' => [
            [
                'title' => 'add',
                'routeName' => 'admin.room.create',
                'icon' => '<i class="ti ti-plus"></i>',
                'roles' => [],
            ],
            [
                'title' => 'list',
                'routeName' => 'admin.room.index',
                'icon' => '<i class="ti ti-list"></i>',
                'roles' => [],
            ],
        ]
    ...
    [
        ...
        'sub' => [
            [
                'title' => 'add',
                'routeName' => 'admin.roomtype.create',
                'icon' => '<i class="ti ti-plus"></i>',
                'roles' => [],
            ],
            [
                'title' => 'list',
                'routeName' => 'admin.roomtype.index',
                'icon' => '<i class="ti ti-list"></i>',
                'roles' => [],
            ],
        ]
...
//            [
//                'title' => 'add',
//                'routeName' => 'admin.booking.create',
//                'icon' => '<i class="ti ti-plus"></i>',
//                'roles' => [],
//            ],
//            [
...
//    ],
    [
        ...
        'sub' => [
            [
                'title' => 'add',
                'routeName' => 'admin.amenities.create',
                'icon' => '<i class="ti ti-plus"></i>',
                'roles' => [],
            ],
            [
